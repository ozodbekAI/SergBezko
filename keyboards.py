...
def get_back_to_generation():
    """Generation menyuga qaytish - FAQAT root level uchun"""
...
def get_normalize_menu() -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="◀️ Назад", callback_data="back_gen_normalize"))
    return builder.as_markup()
...
def get_video_menu() -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="◀️ Назад", callback_data="back_gen_video"))
    return builder.as_markup()
...
def get_photo_menu() -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="◀️ Назад", callback_data="back_gen_photo"))
    return builder.as_markup()
...
def get_product_card_plans() -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="◀️ Назад", callback_data="back_to_root"))
    return builder.as_markup()
...
def get_scene_groups(groups: List[dict]) -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="◀️ Назад", callback_data="back_selecting_scene_groups"))
    return builder.as_markup()
...
def get_scenes_in_group(scenes: List[dict], group_id: str) -> InlineKeyboardMarkup:
    ...
    keyboard.append([InlineKeyboardButton(
        text="◀️ Назад", 
        callback_data="back_selecting_scene_group"
    )])
...
def get_pose_groups(groups: List[dict]) -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="◀️ Назад", callback_data="back_selecting_group"))
    return builder.as_markup()
...
def get_poses_in_group(poses: List[dict], group_id: str) -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(
        text="◀️ Назад", 
        callback_data="back_selecting_group_pose"
    ))
...
def get_model_types(models: List[dict]) -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="◀️ Назад", callback_data="back_norm_new_model"))
    return builder.as_markup()
...
def get_video_scenarios(scenarios: List[dict]) -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="◀️ Назад", callback_data="back_waiting_for_photo"))
    return builder.as_markup()
